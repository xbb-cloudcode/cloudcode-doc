...
module.exports = {
    ...
    return req.respond({
      ...
      body: JSON.stringify({
        ...
        "result": {
          ...
          "lowCodeConfig": {
            "actionList": {},
            "customButtonList": [{"actionList":[{"actionType":5,"buttonId":208,"id":308,"param":{"functionName":"example"},"sort":0}],"id":208,"name":"点我","sort":0,"type":2}],
            "lowCodeJsFile": {
              "fileId": 3734,
              "release": {
        ...
        "result": {
          "lowCodeConfig": {
            ...
            "lowCodeJsFile": {
              "fileId": 3734,
              "release": {
                "attachIndex": "https://cloudcode-usercode.oss-cn-beijing.aliyuncs.com/xbbProPrd/test/395929/4522602_release.js",
                "ext": "text/javascript",
                "filename": "4522602_release.js",
                "size": 790
              },
  ...
  'https://cloudcode-usercode.oss-cn-beijing.aliyuncs.com/xbbProPrd/test/395929/4522602_release.js': req => {
    const body = fs.readFileSync(path.join(__dirname, '../../../codes/lowcode/setValue.js'));
    return req.respond({
      status: 200,
